...
<body>
    ...
    <main>
        ...
        <section id="about">
            ...
            <p>Everything I do is informed by the principles of information design: Is it readable, legible and worth reading? From code to illustration, from wiring diagram layouts to UI design.</p>
            ...
            <p>I led cross-functional teams. I also drove agile transformation as coach for our international aftermarket department. I championed standardized processes and moved teams from uncertainty to clear, actionable planning. I worked at every stage of the product lifecycle. I collaborated with R&D on roadmaps. I industrialized production processes. I closed the feedback loop from field diagnostics back to development.</p>
