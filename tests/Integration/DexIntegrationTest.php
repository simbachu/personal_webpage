...
class DexIntegrationTest extends TestCase
{
    ...
    public function testOgMetaTagsAreGeneratedForPokemonWithOpinion(): void
    {
        ...
        $opinionService->method('getOpinion')->willReturn(\App\Type\Result::success([
        ...
        try {
            //! @section Act
            $monsterData = $presenter->fetchMonsterData(\App\Type\MonsterIdentifier::fromString('pikachu_og'));
            $viewData = $presenter->present($monsterData);
